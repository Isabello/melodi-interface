<template>
  <div class="meta-modal">
    <div v-html="item.svg" class="meta-modal__image" style="margin-bottom: 2px;"/>

    <BaseButton @click.stop="playMidi(item);" style="padding:5px 0px 5px 0px;">Play</BaseButton>


    <div class="meta-modal__title">
      Midi <NumberText>{{ item.seed.seed }}</NumberText>
    </div>
    ...
    <div class="meta-modal__point">
      ...
      <a :href="`https://basescan.org/address/${item.seed.owner}`" class="meta-modal__point-value">
...
import { playMidi } from '@/utils/controlDynamic'
